...
def evaluate_fairness(
    ...
    Numerical sensitive features are automatically converted
    into meaningful groups before fairness metrics are calculated.
    """
    ...
    for feature in sensitive_features:
        ...
        sensitive_feature = dataframe[feature].copy()

        # ----------------------------------------------------
        # GROUP NUMERICAL FEATURES
        # ----------------------------------------------------

        if pd.api.types.is_numeric_dtype(sensitive_feature):

            # Remove NaN temporarily
            ...
            if unique_values > 5:
                ...
                try:
                    ...
                    sensitive_feature = numeric.astype(str)
        ...
        if task_type == "classification":
            ...
            print("\n===== FAIRNESS GROUP DEBUG =====")
            print("Feature:", feature)
            print("Type:", sensitive_feature.dtype)
            print("Groups:")
            print(sensitive_feature.value_counts(dropna=False))
            print("===============================\n")
